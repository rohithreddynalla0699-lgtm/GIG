...
export const orders: Order[] = [
  {
    ...
    pickupCode: '7418',
    amountPaid: 169,
    paymentSummary: 'Reserved in app for demo',
    ...
    timeline: [
      {
        ...
        timeLabel: '6:05 PM',
        title: 'Reserved',
        description: 'Your rescue bag was reserved and your pickup code is ready in the app.',
      },
      {
        id: '7418-2',
        timeLabel: '6:52 PM',
    ...
    timeline: [
      {
        ...
        timeLabel: '6:42 PM',
        title: 'Reserved',
        description: 'Your reservation was confirmed and the pickup code was generated.',
      },
      {
        id: '5930-2',
        timeLabel: '7:55 PM',
